...
function showUniversityProjects() {
    const container = document.getElementById('university-projects-container');
    container.classList.toggle('hidden'); // Afficher ou masquer les images supplémentaires
}
